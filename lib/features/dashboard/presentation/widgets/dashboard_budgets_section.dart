...
class DashboardBudgetsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activeBudgets = budgets.where((b) {
      ...
      return !now.isBefore(b.startDate) && !now.isAfter(endOfDay);
    }).toList();
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      budget.budgetType.getLocalizedName(context).toUpperCase(),
